...
module.exports = class rptimestamptoggleCommand extends commando.Command {
	...
	run (msg, args) {
		...
		return msg.reply(oneLine `The Timestamp in Rich Presence is now ${args.option ? 'enabled' : 'disabled'}. Run ${msg.guild.commandPrefix}rpreload to reload your presence.`);
	}
};