...
module.exports = class TypeCommand extends Command {
  ...
  run (msg, {type}) {
    ...
    for (let z = 0; z < type.split(' ').length; z += 1) {
      const argsSplit = type.split(' ')[z];
    ...
    typeEmbed
      ...
      .addField('External Resources', oneLine`
		[Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/${type.split(' ')[0]}_(type\\))  
		|  [Smogon](http://www.smogon.com/dex/sm/types/${type.split(' ')[0]})
		|  [PokémonDB](http://pokemondb.net/type/${type.split(' ')[0]})`);
