...
module.exports = class rptoggleCommand extends commando.Command {
	constructor (client) {
		super(client, {
			'name': 'rptoggle',
			'group': 'provider',
	...
	run (msg, args) {
		...
		return msg.reply(oneLine `Rich Presence is now ${args.option ? 'enabled' : 'disabled'}. Run ${msg.guild ? msg.guild.commandPrefix : this.client.commandPrefix}rpreload to reload your presence.`);
	}
};